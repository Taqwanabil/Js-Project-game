$(function () {
    ...
    the_game = function () {
        ...
        if (check_rotten_rocket_hits_char(rocket2) || check_rotten_rocket_hits_char_char(rocket2)) {
        ...
        if (check_rotten_rocket_hits_char(rocket5) || check_rotten_rocket_hits_char_char(rocket5)) {
            
            set_rocket_to_initial_position(rocket5);
        } else {
            rocket_down(rocket5);
        }

        if (check_rocket_hits_floor(rocket6) || check_rocket_hits_char(rocket6)) {
            set_rocket_to_initial_position(rocket6);
        } else {
            rocket_down(rocket6);
        }
